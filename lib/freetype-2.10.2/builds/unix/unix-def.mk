...
LIBS_PRIVATE       := 
LIBSSTATIC_CONFIG  := -lfreetype -lz -lpng16 -lm -lz -lm -lz -lharfbuzz -pthread -lm -lfreetype -lbz2 -lpng16 -lm -lz -lm -lz -lgraphite2 -lglib-2.0 -pthread -lpcre -pthread -lbrotlidec -lbrotlicommon
build_libtool_libs := 
ft_version         := 23.2.17
